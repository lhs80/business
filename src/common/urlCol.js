...
const urlCol = {
	...
	follow: {
		sheet: {
			...
			//跟进动态
			trends: {
				url: '/mch/salesman/followList'
			},
			//跟进日志
			businesser: {
				url: '/mch/salesman/getPCustomerAllSalesMan'
			},
			agent: {
				url: '/mch/salesman/getCustomersByRegion'
			},
			querySetting: {
				url: '/mch/salesman/getPCustomerConfig'
			},
			set: {
				url: '/mch/salesman/setPCustomerConfig'
			},
			release: {
	...
	report: {
		team: {
			url: '/mch/salesman/getFollowReportGroup'
		},
		person: {
			url: '/mch/salesman/getFollowReport'
		},
		teams: {
			url: '/mch/salesman/getUseAbleGroup'
		},
		customer: {
			url: '/mch/salesman/getCustomerReport'
		}
	},
	/************************************超管接口*************************************/
	superAdmin: {
