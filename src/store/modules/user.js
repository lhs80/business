    ...
    GetMenu({
      ...
      return new Promise(resolve => {
        ...
        const data = [
          ...
          },
          {
            ...
            children: [{
              ...
              spread: false,
              path: 'openList',
              component: 'views/superAdmin/open/open-list',
              authority: null,
              redirect: null,
              code: null,
              type: '0',
              ...
              spread: false,
              path: 'suClientSearch',
              component: 'views/superAdmin/suClient/suClientSearch',
              authority: null,
              redirect: null,
              code: null,
              type: '0',
              ...
              spread: false,
              path: 'agent',
              component: 'views/superAdmin/open/agent',
              authority: null,
              redirect: null,
              code: null,
              type: '0',
              ...
              spread: false,
              path: 'opensetting',
              component: 'views/superAdmin/open/setting',
              authority: null,
              redirect: null,
              code: null,
              type: '0',
        ...
        if (loginType === 'sh-send') {
          ...
          menuData = data;
        } else if (loginType === 'ywy') {
          menuData = businessData;
        } else if (loginType === 'tdjl') {
          menuData = businessData;
        } else {
          menuData = suData;
        }
