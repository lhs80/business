  ...
  <section class="p2">
    ...
    <table class="order-detail-info">
      <tr>
        <td>
          ...
          <el-button type="primary" size="small" class="mt2" @click="isShowUpdateAddress=true" :disabled="detail.order_status==3">修改订单收货地址</el-button>
    ...
    <table class="order-detail-product-info">
      ...
      <tr v-for="(gooditem,key) in detail.goods" :key="key">
        ...
        <td class="text-muted text-center">￥{{gooditem.price}}</td>
        <td class="text-muted text-center">x{{gooditem.count}}</td>
        <td class="text-muted text-center">￥{{gooditem.pay_total}}</td>
      </tr>
      <tr>
