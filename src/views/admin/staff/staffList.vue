<template>
  <div class="app-container calendar-list-container client-list">
    <el-row>
      <el-col :span="6">
        <el-button type="primary" size="small" @click="$router.push({path:'/admin/addStaff'})">添加员工</el-button>
        <el-button type="primary" size="small" @click="$router.push({path:'/admin/groupList'})">业务员分组</el-button>
      </el-col>
    ...
    <el-row class="mt2">
      <el-col :span="24">
        <el-button type="primary" size="small" @click="wantToChangeType">批量修改分组</el-button>
      </el-col>
    </el-row>
