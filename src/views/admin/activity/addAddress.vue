  ...
  <div class="app-container calendar-list-container addStaff-list">
    ...
    <el-form :model="addressInfo" :rules="rules" ref="addressInfo" label-width="120px">
      <el-form-item label="退货地址名称" prop="name">
        <el-input v-model="addressInfo.name" placeholder="退货地址名称"></el-input>
      </el-form-item>
      ...
      <el-form-item>
        <el-button type="primary" @click="submitForm('addressInfo')">立即创建</el-button>
...
<script>
  import {addAddressListFun} from "@/api/activity"
