      ...
      <div class="table_container">
        ...
        >
          ...
          <el-table-column property="status" label="状态" width="120" align="center">
            <template slot-scope="scope">
              <el-button type="primary">已售空</el-button>
            </template>
          </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        let params = `?type=2&searchKey=${this.searchKey}&pageSize=${this.paginations.page_size}&pageIndex=${this.paginations.page_index}`;
