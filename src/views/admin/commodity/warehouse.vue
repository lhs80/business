  ...
  <div class="app-container calendar-list-container client-list">
    <div v-if="commodityIsShow">
      ...
      <div class="chushou-btn">
        <div class="client-edit-level">
          <el-button type="primary" size="small" @click="changeGoodStatus">上架</el-button>
        </div>
        <div class="client-edit-level">
      ...
      <div class="table_container">
        ...
        >
          ...
          <el-table-column property="status" label="状态" width="180" align="center">
            <template slot-scope="scope">
              <el-button type="primary" size="small">已下架</el-button>
            </template>
          </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      getData() {
        let params = `?type=3&searchKey=${this.searchKey}&pageSize=${this.paginations.page_size}&pageIndex=${this.paginations.page_index}`;
