      ...
      <el-tab-pane label="跟进客户" name="first">
        ...
        <div class="bg-white">
          ...
          <div>
            ...
            <span>
              <el-radio v-model="searchMyParams.brand_id" label="1">备选项</el-radio>
              <el-radio v-model="searchMyParams.brand_id" label="2">备选项</el-radio>
            </span>
          </div>
        </div>
        <hr>
...
<script>
  import {addMyCustomerFun, followDoneListFun, followMyListFun, addFollowRecordFun} from "@/api/activity"
