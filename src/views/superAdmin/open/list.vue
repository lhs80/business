<template>
  <div style="position:relative" class="app-container calendar-list-container client-list">
    ...
    <el-dialog title="新增客户" :visible="showExportCustomer" width="600px">
      <el-form :model="customerInfo">
        ...
        <el-form-item label="品牌" :label-width="formLabelWidth">
          <el-input size="small" v-model="customerInfo.brand_ids" autocomplete="off"></el-input>
        </el-form-item>
    ...
    <el-dialog title="写跟进" :visible="showFollowRecord!==''">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-select placeholder="请选择" size="small" style="width:100%" v-model="followRecordInfo.follow_type">
