 ...
 * 客户报表
 * */
export function customerListFun(params) {
  return request({
    url: urlCol.report.customer.url,
    method: 'get',
    params
  })
}
 ...
 * 超时提醒
 * */
export function getOverTimeNoticFun(params) {
  return request({
    url: urlCol.open.sheet.tips.url,
    method: 'get',
    params
  })
}
 ...
 * 20200419新增客户地址搜索
 * **/
export function serarchCustomByAdr(params) {
  return request({
    url: urlCol.poi.searchClient.url,
    method: 'get',
    params
  })
}
